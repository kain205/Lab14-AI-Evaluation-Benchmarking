...
Kết quả được merge và deduplicate theo question text, với typed results được ưu tiên. Chiến lược này giúp đạt Hit Rate = **94%** trên toàn bộ 50 test cases — 3 cases miss do câu hỏi out-of-scope không có ground_truth_ids.
...
Kết quả Hit Rate = MRR = **0.94** (94%) trên 50 test cases cho thấy embedding `text-embedding-3-small` + ChromaDB hoạt động tốt với dữ liệu Q&A tiếng Việt của XanhSM. 3 cases miss đều là out-of-scope (ground_truth_ids rỗng) — không phải lỗi retrieval thực sự.
